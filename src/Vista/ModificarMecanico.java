...
public class ModificarMecanico extends JDialog {
    ...
    private Object mecanicoSeleccionado;
    ...
    public static void main(String[] args) {
        try {
            ModificarMecanico dialog = new ModificarMecanico(null);
     ...
     * Create the dialog.
     */
    public ModificarMecanico(Object mecanico) {
        this.mecanicoSeleccionado = mecanico;
        ...
        lblUsuario.setBounds(10, 200, 80, 14);
        contentPanel.add(lblUsuario);

        usuarioField = new JTextField();
        usuarioField.setBounds(100, 197, 200, 20);
        contentPanel.add(usuarioField);
        usuarioField.setColumns(45);

        JLabel lblContrasena = new JLabel("Contraseña:");
        lblContrasena.setBounds(10, 230, 80, 14);
        contentPanel.add(lblContrasena);

        contrasenaField = new JTextField();
        contrasenaField.setBounds(100, 227, 200, 20);
        contentPanel.add(contrasenaField);
        contrasenaField.setColumns(45);

        try {
            ConectorBD conector = new ConectorBD();
            Connection conn = conector.conexionCorrecta();
            Statement stmt = conn.createStatement();
            String query = "SELECT * FROM usuario WHERE nif = '" + mecanicoSeleccionado + "'";
            ...
            while (rs.next()) {
                ...
                apellido1Field.setText(apellido1);
                apellido2Field.setText(apellido2);
                telefonoField.setText(telefono);
                emailField.setText(email);
                usuarioField.setText(usuario2);
